...
const MyReviewsScreen: React.FC = () => {
  ...
  const renderSummary = () => {
    const reviews = activeTab === 'written' ? writtenReviews : receivedReviews;
  ...
  const renderWrittenReview = (review: WrittenReview) => {
  ...
  const renderReceivedReview = (review: ReceivedReview) => {
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner}>
        ...
        {currentReviews.length === 0 ? (
          ...
          <View style={styles.reviewsList}>
            {activeTab === 'written'
              ? writtenReviews.map(renderWrittenReview)
